<?php
// HTTP
define('HTTP_SERVER', 'http://digital-store-opencart-15x-rinodung-1.c9users.io:80/');

// HTTPS
define('HTTPS_SERVER', 'http://digital-store-opencart-15x-rinodung-1.c9users.io:80/');
