<?php
// HTTP
define('HTTP_SERVER', 'http://digital-store-opencart-15x-rinodung-1.c9users.io:80/admin/');
define('HTTP_CATALOG', 'http://digital-store-opencart-15x-rinodung-1.c9users.io:80/');

// HTTPS
define('HTTPS_SERVER', 'http://digital-store-opencart-15x-rinodung-1.c9users.io:80/admin/');
define('HTTPS_CATALOG', 'http://digital-store-opencart-15x-rinodung-1.c9users.io:80/');
...
define('DB_HOSTNAME', '0.0.0.0');
define('DB_USERNAME', 'rinodung');
define('DB_PASSWORD', '');
